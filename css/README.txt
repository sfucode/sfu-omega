...
To use these stylesheets, rename the files and sfu_omega with the name of your theme.
...
sfu_omega-alpha-default-narrow.css  
...
sfu_omega-alpha-default-normal.css
...
sfu_omega-alpha-default-wide.css
